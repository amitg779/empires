...
var structures = [
        ...
        },
        {
            ...
            hitpoints: [1200, 1300, 1400, 1500, 1600, 1700, 2300, 2545],
            costCash: [0, 1200, 4600, 8600, 16000, 28000, 48000, 79000],
            costIron: [0, 0, 0, 0, 0, 4700, 10000, 20000],
            buildTime: [0, 300, 1800, 5400, 9000, 12600, 18000, 25200],
            upgradeExp: [0, 20, 20, 25, 25, 30, 35, 40],
            instantGold: [0, 8, 28, 68, 101, 159, 240, 353],
            levelUpgradeLimit: [1, 1, 1, 2, , 6, 7, 8],
            commandPoints: [3, 4, 5, 6, 7, 8, 9, 10],
        ...
        },
        {
            type: "Operations",
            name: "Storage Bunker",
            hitpoints: [1100, 1200, 1350, 1580, 1830, 2025, 2665, 3205, 3745],
            costCash: [0, 1600, 3000, 5800, 11000, 19000, 32000, 53000, 85000],
            costIron: [0, 0, 0, 0, 0, 3200, 6600, 13000, 26000],
            buildTime: [0, 1800, 3600, 5400, 8100, 10800, 14400, 18000, 21600],
            upgradeExp: [0, 20, 25, 30, 35, 40, 40, 45, 50],
            instantGold: [0, 18, 42, 59, 87, 128, 180, 256, 362],
            levelUpgradeLimit: [, , , , , , 7],
            storageCapacityOil: [1000, 2000, 3000, 4500, 6500, 11000, 13000, 33000, 51000],
            storageCapacityCash: [1000, 2000, 3000, 4500, 6500, 8500, 10000, 15000, 23000],
            storageCapacityIron: [0, 0, 0, 0, 1100, 1700, 2500, 4400, 8100],
            storageCapacityTech: [0, 0, 0, 0, 0, 0, 0, 0, 1000, ],
            storageReserve: ['50%', '52%', '54%', '56%', '58%', '60%', '62%', '64%', '66%'],
        ...
        },
        {
            ...
            costCash: [1200, 2400, , 8700, 16000, 28000, 48000, 80000],
            costIron: [0, 0, 0, 0, 0, 4800, 10000, 20000],
            buildTime: [3600, 6300, , 14400, 18000, 23400, 28800, 36000],
            upgradeExp: [0, 10, 14, 15, 17, 20, 21, 24, 24],
            instantGold: [0, 37, , 82, 140, 206, 287, 402],
    	...
    	},
    	{
    	    type: "Defenses",
    	    name: "Rally Flag",
    	    costCash: [800, 1700, 11000, 34000],
            costIron: [0, 0, 0, 7100],
    	    buildTime: [3, 3600, 9900, 15300],
    	    upgradeExp: [0, 20, 25, 35, 45],
    	    instantGold: [0, 28, 95, 190],
    	...
    	},
        {
            ...
            costCash: [300, 600, 1350, 2400, 4500, 8300, 15000, 25000, 42000, 67000],
            costIron: [0, 0, 0, 0, 0, 0, 2500, 5200, 11000, 20000],
            buildTime: [60, 60, 3600, 5400, 7200, 9000, 11700, 14400, 18000, 21600],
            upgradeExp: [0, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50],
            instantGold: [0, 4, 27, 35, 47, 65, 100, 162, 230, 314],
        ...
        },
        {
            type: "Resources",
            name: "Fuel Stockpile",
            hitpoints: [1560, 1620, 1818, 2118, 2520, 2730, 3480],
            costCash: [1100, 2200, 4400, 8200, 15000, , 46000],
            costIron: [0, 0, 0, 0, 0, 4500, 9500],
            buildTime: [3, 1800, 3600, 5400, 8100, 10800, 13500],
            upgradeExp: [0, 10, 15, 20, 25, 30, 35],
            instantGold: [0, 20, , 55, 79, 127, 215],
            levelBuildLimit: [1, 1, 1, 1, 1, 1, 1, 2],
            levelUpgradeLimit: [1, 2, 3, 4],
            storageCapacityOil: [1000, 3000, 5000, 10000, 21000, 69000, 120000],
        ...
        },
        {
            ...
            name: "Supply Drop",
            hitpoints: [1000, 1200, 1400, 1700, 2000, 2400, 2750, 3500, 3950, 5000, 5600],
            costCash: [200, 500, 1250, 2200, 4100, 7500, 13000, 23000, 38000, 61000],
            costIron: [0, 0, 0, 0, 0, 0, 2300, 4700, 9600, 18000],
            buildTime: [60, 60, 2700, 4500, 6300, 8100, 10800, 13500, 14400, 18000],
            upgradeExp: [0, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50],
            instantGold: [0, 4, 21, 32, 43, 60, 92, 153, 202, 282],
        ...
        },
        {
            ...
            hitpoints: [2730, 3480, 3780, 4950],
            costCash: [15000, 27000, 47000, 78000],
            costIron: [0, 4600, 9800, 20000],
            buildTime: [3600, 7200, 12600, 18000],
            upgradeExp: [0, 30, 35, 40],
            instantGold: [0, 118, 214, 320],
            storageCapacityIron: [5000, 11000, 23000],
        ...
        },
        {
            ...
            costCash: [16000, 27400, 45400, 73200],
            costIron: [2700, 5700, 11500, 22100],
            buildTime: [3600, 5400, 7200, 9000],
            upgradeExp: [0, 35, 40, 45, 50],
            instantGold: [0, 128, 190, 275],
